...
export default function FoodDeliveryApp() {
  ...
  // View options: login, forgot-pass, home, menu, food-detail, cart, tracking, favorites, orders, profile, 
  // Sub-views: edit-profile, addresses, payments, notifications, settings
  ...
  const LoginView = () => (
    <div className="min-h-screen bg-white p-6 flex flex-col justify-center">
      ...
      <form onSubmit={(e) => { e.preventDefault(); setUser({ name: 'Alex Johnson', email: 'alex@example.com', phone: '+1 234 567 890' }); setView('home'); }}>
      ...
      <div className="min-h-screen bg-gray-50 pb-24">
        ...
        <div className="bg-white p-6 sticky top-0 z-10 shadow-sm">
          ...
          <div className="relative">
            ...
            <input 
              type="text" 
              className="w-full bg-gray-100 pl-10 pr-4 py-3 rounded-xl outline-none focus:ring-2 focus:ring-orange-200"
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      {cart.length > 0 && (
        <div className="bg-white p-6 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
          ...
          <Button onClick={() => { setCart([]); setView('tracking'); }}>
            Checkout
          </Button>
        </div>
      )}
  ...
  return (
    <div className="font-sans text-gray-900 max-w-md mx-auto bg-white min-h-screen shadow-2xl overflow-hidden relative">
      ...
      {/* Floating Bottom Nav for Main Pages */}
